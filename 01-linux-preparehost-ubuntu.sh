...
sudo apt remove libqt6*-dev libheif-dev libopencv-dev libexiv2-dev nodejs libavcodec-dev libavutil-dev libswresample-dev libavformat-dev libavfilter-dev libavdevice-dev libswscale-dev libavif-dev
